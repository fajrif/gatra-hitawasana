...
import { Monitor, Smartphone, Server, ServerCog, Database, DatabaseZap } from 'lucide-react';
import { KotlinLogo, SwiftLogo, ViteLogo, ReactLogo, VueLogo, NodejsLogo, NginxLogo } from '@/components/ui/custom-icons';
            ...
            <AnimatedGlowingBox>
                <div className="rounded-lg py-4 sm:py-6 px-3 sm:px-4 bg-black border-1 border-white/20 transition-all duration-300">
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-2">
                        ...
                        {/* Cache */}
                        <div className="flex flex-row items-start gap-3 sm:gap-4">
                            <DatabaseZap className="w-6 h-6 sm:w-8 sm:h-8 text-white/70 flex-shrink-0" strokeWidth={1} />
                            <div className="text-start flex-1">
